...
//    mButtonSpacing = (int) (getResources().getDimension(R.dimen.fab_actions_spacing) - getResources().getDimension(R.dimen.fab_shadow_radius) - getResources().getDimension(R.dimen.fab_shadow_offset));
        ...
        mButtonSpacing =dip2px(getContext(),attr.getDimension(R.styleable.FloatingActionsMenu_fab_buttonSpacing, 4));
    ...
    private void createAddButton(Context context) {
        if (mAddButtonStyle == STYLE_DEFAULT) {
            ...
            mAddButton.setId(R.id.fab_expand_menu_button);
            ViewGroup.LayoutParams layoutParams = new ViewGroup.LayoutParams(dip2px(getContext(),mAddButtonWidth), dip2px(getContext(),mAddButtonHeight));
